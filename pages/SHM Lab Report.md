		...
		- ### 3.3.4 K Calculation
		  Depending on the mass of the object, the K constant increases drastically. I believe this is due to imperfect timing or perhaps an imperfect system.
			- ### 3.3.5 Cosine vs. Sine Fit
			  Nothing changes given my equation, it only adjusts the phase of the equation - which makes sense. It could also have flipped the amplitude had I given slightly different data, but that did not happen for me.X
- # Discussion
  ...
- # Conclusion
  ...