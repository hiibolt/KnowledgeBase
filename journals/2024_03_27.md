...
- NOW Project for [[MATH360]] (Due the 5th ASAP!!!!!)
  ...
  :END:
	...
	- ## Problem 6
	  ...
	  $$F = l^{\frac{3}{2}}g^{\frac{1}{2}}\mu h (\frac{P}{g\mu e^2})^a (n\sqrt{\frac{e}{g}})$$
	  
	  F=R -> express u ($n \propto l^{\frac{-1}{2}}$)
	  
	  Find: (yeah T-T)
	  $$\frac{\partial v}{\partial P}, \frac{\partial v}{\partial n}, \frac{\partial v}{\partial A}, \frac{\partial v}{\partial g}, \frac{\partial v}{\partial l}$$
	- ## Problem 7
